    ...
    children: [
      {
        ...
        component: () => import('@/views/drug/import/batch/index.vue'),
        meta: {
          title: '批量导入',
          icon: 'ep:files',
          noCache: false,
      ...
      {
        path: 'detail/:id',
        name: 'DrugImportTaskDetail',
        component: () => import('@/views/drug/import/detail/index.vue'),
        meta: {
          title: '任务详情',
          icon: 'ep:view',
          noCache: false,
      ...
      },
      {
        ...
        component: () => import('@/views/drug/report/submission/index.vue'),
        meta: {
          title: '数据上报',
          icon: 'ep:upload',
          noCache: false,
